...
execute at @s if entity @s[type=#veer:soul_poes/skeletons,tag=veer.soul_poes.new,tag=!global.ignore,tag=!global.ignore.pos,predicate=veer:soul_poes/soul_poe/spawn_chance,predicate=veer:soul_poes/in_soul_sand_valley] run function veer:soul_poes/poe_jockey/replace_ssv

## New Skeleton in mineshaft
execute at @s if entity @s[type=skeleton,tag=veer.soul_poes.new,tag=!global.ignore,tag=!global.ignore.pos,predicate=veer:soul_poes/poe_jockey/spawn_chance,predicate=veer:soul_poes/in_mineshaft] run function veer:soul_poes/poe_jockey/skeleton_mineshaft/replace

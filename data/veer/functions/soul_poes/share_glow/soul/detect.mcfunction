...
execute at @s as @e[type=potion,tag=veer.soul_poes.share_glow.soul, distance=..20] unless score @s veer.soul_poes.glowTimer matches 7..10 run function veer:soul_poes/fix_glowing/start